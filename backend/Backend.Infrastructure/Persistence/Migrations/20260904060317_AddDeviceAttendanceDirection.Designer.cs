...
namespace Backend.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260904060317_AddDeviceAttendanceDirection")]
    partial class AddDeviceAttendanceDirection
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Domain.Entities.AttendancePermission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("attendance_permissions", (string)null);
                });
            ...
            modelBuilder.Entity("Backend.Domain.Entities.Card", b =>
                {
                    ...
                    b.ToTable("cards", null, t =>
                        {
                            t.HasCheckConstraint("CK_Cards_Owner", "(\"EmployeeId\" IS NOT NULL)::int + (\"VisitorId\" IS NOT NULL)::int + (\"GymCustomerId\" IS NOT NULL)::int = 1");
                        });
                });
            ...
            modelBuilder.Entity("Backend.Domain.Entities.Device", b =>
                {
                    ...
                    b.Property<int>("AttendanceDirection")
                        .HasColumnType("integer");

                    b.Property<int?>("BarrierOutput")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("ParkingDirection")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Backend.Domain.Entities.Face", b =>
                {
                    ...
                    b.ToTable("faces", null, t =>
                        {
                            t.HasCheckConstraint("CK_Faces_Owner", "(\"EmployeeId\" IS NOT NULL)::int + (\"VisitorId\" IS NOT NULL)::int + (\"GymCustomerId\" IS NOT NULL)::int = 1");
                        });
                });
            ...
            modelBuilder.Entity("Backend.Domain.Entities.Fingerprint", b =>
                {
                    ...
                    b.ToTable("fingerprints", null, t =>
                        {
                            t.HasCheckConstraint("CK_Fingerprints_Owner", "(\"EmployeeId\" IS NOT NULL)::int + (\"VisitorId\" IS NOT NULL)::int + (\"GymCustomerId\" IS NOT NULL)::int = 1");
                        });
                });
            ...
            modelBuilder.Entity("Backend.Domain.Entities.GymPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("gym_payments", (string)null);
                });

            modelBuilder.Entity("Backend.Domain.Entities.GymProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("gym_products", (string)null);
                });

            modelBuilder.Entity("Backend.Domain.Entities.GymPurchaseOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("gym_purchase_orders", (string)null);
                });

            modelBuilder.Entity("Backend.Domain.Entities.GymPurchaseOrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Backend.Domain.Entities.GymStockMovement", b =>
                {
                    ...
                    b.ToTable("gym_stock_movements", (string)null);
                });
            ...
            modelBuilder.Entity("Backend.Domain.Entities.GymStocktake", b =>
                {
                    ...
                    b.ToTable("gym_stocktakes", (string)null);
                });

            modelBuilder.Entity("Backend.Domain.Entities.GymStocktakeItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("gym_stocktake_items", (string)null);
                });

            modelBuilder.Entity("Backend.Domain.Entities.GymSupplier", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("gym_suppliers", (string)null);
                });
            ...
            modelBuilder.Entity("Backend.Domain.Entities.ParkingHolder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("parking_holders", (string)null);
                });
            ...
            modelBuilder.Entity("Backend.Domain.Entities.ParkingSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("OverstayUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Backend.Domain.Entities.WorkSchedule", b =>
                {
                    ...
                    b.Property<bool>("LunchBreakDeductionEnabled")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Backend.Domain.Entities.Card", b =>
                {
                    ...
                    b.HasOne("Backend.Domain.Entities.GymCustomer", "GymCustomer")
                        .WithMany()
            ...
            modelBuilder.Entity("Backend.Domain.Entities.GymPayment", b =>
                {
                    ...
                    b.HasOne("Backend.Domain.Entities.GymMembership", "Membership")
                        .WithMany()
            ...
            modelBuilder.Entity("Backend.Domain.Entities.GymProduct", b =>
                {
                    b.HasOne("Backend.Domain.Entities.GymSupplier", "Supplier")
                        .WithMany()
            ...
            modelBuilder.Entity("Backend.Domain.Entities.GymPurchaseOrderItem", b =>
                {
                    ...
                    b.HasOne("Backend.Domain.Entities.GymPurchaseOrder", "PurchaseOrder")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Backend.Domain.Entities.GymStocktakeItem", b =>
                {
                    ...
                    b.HasOne("Backend.Domain.Entities.GymStocktake", "Stocktake")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Backend.Domain.Entities.ParkingSession", b =>
                {
                    b.HasOne("Backend.Domain.Entities.ParkingSpace", "Space")
                        .WithMany()
            ...
            modelBuilder.Entity("Backend.Domain.Entities.ParkingVehicle", b =>
                {
                    b.HasOne("Backend.Domain.Entities.ParkingHolder", "Holder")
                        .WithMany("Vehicles")
